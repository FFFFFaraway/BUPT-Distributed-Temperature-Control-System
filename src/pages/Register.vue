    ...
    <b-overlay :show="loading" rounded="sm">
      <div class="container">
        ...
        <div>
          ...
          <b-alert show variant="info">Customer? click <a href="#/login">here</a> to sign in right now.</b-alert>
        </div>
        <b-form @submit="register" @reset="onReset">
          ...
          <b-button-group>
          <b-button type="submit" variant="primary" :disabled="!checkCode">Submit</b-button>
