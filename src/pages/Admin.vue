      ...
      <b-overlay :show="loading" rounded="sm">
        <div class="container">
            ...
            <template v-slot:row-details="details">
                <b-form @submit="checkIn(details.item.id)" @reset="checkOut(details.item.id)">
                  ...
                  <b-button type="reset" variant="danger">Check Out</b-button>
                  </b-button-group>
...
export default {
    data() {
        return {
            fields: ['id', 'name','checkInDate','cost','state','expectSpeed','expectTemp','speed','temp','show_details'],
        }
    },
    computed:{
